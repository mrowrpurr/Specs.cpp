...
-- (Optional) For integration with assertion libraries:
add_requires("specs_cpp_snowhouse", "specs_cpp_libassert")
...
target("MySpecs")
    ...
    -- (Optional) For integration with assertion libraries:
    add_packages("specs_cpp_snowhouse", "specs_cpp_libassert")
```
