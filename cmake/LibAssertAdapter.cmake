set(LIBRARY_NAME specs_libassert)

add_library(${LIBRARY_NAME} INTERFACE)
target_include_directories(${LIBRARY_NAME} INTERFACE
    $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/Specs.LibAssert/include>
...
if(NOT CMAKE_BUILD_TYPE STREQUAL "Debug")
    install(DIRECTORY Specs.LibAssert/include/ DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}")
endif()
